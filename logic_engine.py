"""
REGOLA Standalone v1.2 - Logic Engine (BLINDATO)
Modulo per la gestione della logica normativa e l'assemblaggio dei testi legali.
Aggiornato con GDPR, Congruità, Rotazione rafforzata e Durata.
"""
...
def assembla_visti(dati: Dict) -> list:
    ...
    # ROTAZIONE E MOTIVAZIONE SCELTA (Cruciale)
    if imponibile < 5000:
...
def genera_premesse(dati: Dict) -> str:
    ...
    # 4. Motivazione Scelta e Rotazione (Punto 2 e 3 della tua richiesta)
...
def genera_dispositivo(dati: Dict) -> str:
    ...
    # Punto 1: Affidamento e Durata (Punto 5 della richiesta)
    ...
    # Pubblicità e Trasparenza (Punto 7)
